                        ...
                        <div className='flex  text-white justify-center'>
                            <div className='bg-black rounded p-16 transparent'>
                                <div className='w-80 xl:w-80'>
                                    ...
                                    {
                                        loginErr ?
                                            <p className='text-red-600 font-bold pt-2'>{loginErr}</p>
                                            : null
                                    }
                                    ...
                                    <div className='text-gray-600 font-bold pt-7 pb-20'>
                                        <p>New to Netflix? <Link to="/" className='text-white no-underline'> Sign up now.</Link></p>
